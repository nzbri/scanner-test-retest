...
mri.av <- mri %>% 
  ...
  mutate(gm.vol.cat12.rel = gm.vol.cat12/gm.vol.cat12[2]) %>% 
  mutate(wm.vol.cat12.rel = wm.vol.cat12/wm.vol.cat12[2]) %>% 
  mutate(csf.vol.cat12.rel = csf.vol.cat12/csf.vol.cat12[2]) %>% 
  mutate(cbf.gm.cat12.rel = cbf.gm.cat12/cbf.gm.cat12[2])
...
#Create a dataframe to create a global plot from CAT12 (volumetric) processing with: 
# Total GM volume
# White matter volume
# CSF volume
# GM CBF 
...
global.mri.cat12.plot <- fs %>% 
  select(id, session, gm.vol.cat12.rel, wm.vol.cat12.rel, csf.vol.cat12.rel, cbf.gm.cat12.rel) %>% 
  gather(roi, metric, c( `gm.vol.cat12.rel`,
                          `wm.vol.cat12.rel`,
                          `csf.vol.cat12.rel`,
                          `cbf.gm.cat12.rel`)) %>% 
    mutate(roi=factor(roi))
...
av.p.global.mri <- global.mri.plot%>%
...
## With MEAN lines***********************************
p.rel.vol.AV<- ggplot(vol.roi.rel, aes(x=session,y=rel.vol)) +
  geom_line(aes(group=id),alpha=0.3) +
  geom_point(alpha=0.3) +
  scale_x_discrete('Session') +
...
## With MEAN lines***********************************
p.rel.cbf.cort.AV<- ggplot(cbf.cort.roi.rel, aes(x=session,y=rel.cbf)) +
  geom_line(aes(group=id),alpha=0.3) +
  geom_point(alpha=0.3) +
  scale_x_discrete('Session') +
  ...
  facet_wrap(~roi) +
  guides(color=guide_legend(title="")) +
  geom_point(data=av.dataframe.cbf.cort, aes(x=session, y=av,color=roi))+
  geom_line(data=av.dataframe.cbf.cort, aes(x=session, y=av,color=roi, group=roi)) +
  theme(legend.position = "none")
p.rel.cbf.cort.AV

ggsave("Rel_CBF_cort_by_roi_s2REF_WITHav.pdf",width=8,height=5)
##***********************************************************************
...
cbf.sub.cort.roi.rel <- cbf.sub.cort.roi.rel %>% 
  filter(roi!="Accumb")
p.rel.cbf.sub.cort.AV<- ggplot(cbf.sub.cort.roi.rel, aes(x=session,y=rel.cbf)) +
  geom_line(aes(group=id),alpha=0.3) +
  geom_point(alpha=0.3) +
  scale_x_discrete('Session') +
  ylab("Relative CBF change") +
  #scale_y_continuous(breaks=c(0.9, 1.0, 1.1)) +
  facet_wrap(~roi) +
  geom_point(data=av.dataframe.sub.cbf.cort, aes(x=session, y=av,color=roi))+
  geom_line(data=av.dataframe.sub.cbf.cort, aes(x=session, y=av,color=roi, group=roi)) +
  guides(color=guide_legend(title="")) + 
  theme(legend.position = "none")
p.rel.cbf.sub.cort.AV

ggsave("Rel_CBF_Subcort_by_roi_s2REF_AV.pdf",width=8,height=5)
##***********************************************************************
...
## With MEAN lines***********************************
p.rel.fa.AV<- ggplot(fa.roi.rel, aes(x=session,y=fa)) +
  geom_line(aes(group=id),alpha=0.3) +
  geom_point(alpha=0.3) +
  scale_x_discrete('Session') +
  ...
  facet_wrap(~roi) +
  geom_point(data=av.dataframe.fa, aes(x=session, y=av,color=roi))+
  geom_line(data=av.dataframe.fa, aes(x=session, y=av,color=roi, group=roi)) +
  guides(color=guide_legend(title="")) + 
theme(legend.position = "none")
p.rel.fa.AV


ggsave("Rel_FA_by_roi_s2REF_AV.pdf",width=8,height=5)
##***********************************************************************
...
## With MEAN lines***********************************
p.rel.md.AV<- ggplot(md.roi.rel, aes(x=session,y=md)) +
  geom_line(aes(group=id),alpha=0.3) +
  geom_point(alpha=0.3) +
  scale_x_discrete('Session') +
  ...
  scale_y_continuous(limits=c(0.8, 1.2), breaks=c(0.8, 0.9, 1.0, 1.1, 1.2)) +
  facet_wrap(~roi) +
  geom_point(data=av.dataframe.md, aes(x=session, y=av,color=roi))+
  geom_line(data=av.dataframe.md, aes(x=session, y=av,color=roi, group=roi)) +
  guides(color=guide_legend(title="")) + 
theme(legend.position = "none")
p.rel.md.AV

ggsave("Rel_MD_by_roi_s2REF_AV.pdf",width=8,height=5)
##***********************************************************************
...
## With MEAN lines***********************************
p.rel.ad.AV<- ggplot(ad.roi.rel, aes(x=session,y=ad)) +
  geom_line(aes(group=id),alpha=0.3) +
  geom_point(alpha=0.3) +
  scale_x_discrete('Session') +
  ...
  scale_y_continuous(limits=c(0.8, 1.2), breaks=c(0.8, 0.9, 1.0, 1.1, 1.2)) +
  facet_wrap(~roi) +
  geom_point(data=av.dataframe.ad, aes(x=session, y=av,color=roi))+
  geom_line(data=av.dataframe.ad, aes(x=session, y=av,color=roi, group=roi)) +
  guides(color=guide_legend(title="")) + 
theme(legend.position = "none")
p.rel.ad.AV

ggsave("Rel_AD_by_roi_s2REF_AV.pdf",width=8,height=5)
##***********************************************************************
...
## With MEAN lines***********************************
p.rel.rd.AV<- ggplot(rd.roi.rel, aes(x=session,y=rd)) +
  geom_line(aes(group=id),alpha=0.3) +
  geom_point(alpha=0.3) +
  scale_x_discrete('Session') +
  ...
  scale_y_continuous(limits=c(0.8, 1.2), breaks=c(0.8, 0.9, 1.0, 1.1, 1.2)) +
  facet_wrap(~roi) +
  geom_point(data=av.dataframe.rd, aes(x=session, y=av,color=roi))+
  geom_line(data=av.dataframe.rd, aes(x=session, y=av,color=roi, group=roi)) +
  guides(color=guide_legend(title="")) + 
theme(legend.position = "none")
p.rel.rd.AV

ggsave("Rel_RD_by_roi_s2REF_AV.pdf",width=8,height=5)
##***********************************************************************
...
##Figure: Relative (CAT12) by metric
```{r Relative by metric CAT12, echo=FALSE, warning=FALSE}

global.mri.cat12.plot$session <- relevel(global.mri.cat12.plot$session,ref="S1")
#levels(mri.roi.rel$session) <- c("S1", "S2", "S3")
#Rename levels
levels(global.mri.cat12.plot$roi) <- c("CBF","CSF Vol", "GM Vol", "WM Vol")

#Relevel ROI
global.mri.cat12.plot$roi <- fct_relevel(global.mri.cat12.plot$roi, "GM Vol",
                              "WM Vol", "CSF Vol", "CBF")


av.p.global.mri.cat12 <- global.mri.cat12.plot%>%
  group_by(session,roi)%>%
  dplyr::summarize(av = mean(metric))
av.dataframe <- data.frame(av.p.global.mri.cat12)


p.global.mri.cat12<- ggplot(global.mri.cat12.plot, aes(x=session,y=metric)) +
  geom_line(aes(group=id),alpha=0.3) +
  geom_point(alpha=0.3) +
  scale_x_discrete('Session') +
  ylab("Relative MRI change (CAT12)") +
  #scale_y_continuous(breaks=c(0.6, 0.8, 1.0, 1.2)) +
  facet_wrap(~roi) +
  guides(color=guide_legend(title="")) + 
  geom_point(data=av.dataframe, aes(x=session, y=av,color=roi))+ 
...
ggsave("Global_MRI_CAT12_by_metric.pdf",width=8,height=5)
...
##STATS: CAT12
###GM VOL(CAT12)
```{r GM VOL CAT12 model, eval=FALSE, echo=FALSE}

#S2 as reference (1st scan at new location)
fs$session <- relevel(fs$session, ref="S2")

prior_name = paste0('student_t(3,0,',mean(fs$gm.vol.cat12)*prior_percent,')', sep="")

##
## Model 1 -- Bias + shared variance across move & within
## 
#0 chains
gm.cat12.bias.common <- brm(gm.vol.cat12 ~  session + (common|id),
           control = list(adapt_delta = 0.99,max_treedepth=15),
           iter = 10000, family=student(), data=fs,
           algorithm = c("sampling"),
           prior = set_prior(prior_name,class="b"))
summary(gm.cat12.bias.common)
...
#4 chain
prior_name = paste0('student_t(3,0,',mean(fs$gm.vol.cat12)*0.1,')', sep="")
gm.cat12.bias.session <- brm(gm.vol.cat12 ~  session + (session|id),
           control = list(adapt_delta = 0.99,max_treedepth=15),
           iter = 15000, family=student(), data=fs,
           algorithm = c("sampling"), 
           prior = set_prior(prior_name,class="b"))
summary(gm.cat12.bias.session)


##
## Model3 -- Bias + Variable variance across move & within / ICV
## 
prior_name = paste0('student_t(3,0,',mean(fs$gm.vol.cat12/fs$icv.vol.cat12)*0.1,')', sep="")
# 4 chain
gm.cat12.icv.bias.session <- brm(gm.vol.cat12/icv.vol.cat12 ~  session + (session|id),
           control = list(adapt_delta = 0.999,max_treedepth=15),
           iter = 15000, family=student(), data=fs,
           algorithm = c("sampling"), 
           prior = set_prior(prior_name,class="b"))
summary(gm.cat12.icv.bias.session)


##
## Get values for table
##
per_diff(gm.cat12.bias.session)
per_diff(gm.cat12.icv.bias.session)
...
##
# 
# gm.cat12.bias.common <- add_criterion(gm.cat12.bias.common,"kfold")
# gm.cat12.bias.session <- add_criterion(gm.cat12.bias.session,"kfold")
# 
# gm.cat12.kfold <- loo_compare(gm.cat12.bias.common, gm.cat12.bias.session, criterion="kfold")
# 
# #Get ELPD for the common model: 
# print(gm.cat12.bias.common$kfold$estimates)

```

###WM VOL(CAT12)
```{r WM VOL CAT12 model, eval=FALSE, echo=FALSE}

#S2 as reference (1st scan at new location)
fs$session <- relevel(fs$session, ref="S2")

prior_name = paste0('student_t(3,0,',mean(fs$wm.vol.cat12)*prior_percent,')', sep="")

##
## Model 1 -- Bias + shared variance across move & within
## 
#0chains
wm.cat12.bias.common <- brm(wm.vol.cat12 ~  session + (common|id),
           control = list(adapt_delta = 0.99,max_treedepth=15),
           iter = 10000, family=student(), data=fs,
           algorithm = c("sampling"),
           prior = set_prior(prior_name,class="b"))
summary(wm.cat12.bias.common)
...
wm.cat12.bias.session <- brm(wm.vol.cat12 ~  session + (session|id),
           control = list(adapt_delta = 0.99,max_treedepth=15),
           iter = 15000, family=student(), data=fs,
           algorithm = c("sampling"), 
           prior = set_prior(prior_name,class="b"))
summary(wm.cat12.bias.session)
check_hmc_diagnostics(wm.cat12.bias.session$fit)
...
# 2 chains
wm.cat12.icv.bias.session <- brm(wm.vol.cat12/icv.vol.cat12 ~  session + (session|id),
           control = list(adapt_delta = 0.999,max_treedepth=15),
           iter = 15000, family=student(), data=fs,
           algorithm = c("sampling"), 
           prior = set_prior(prior_name,class="b"))
summary(wm.cat12.icv.bias.session)
check_hmc_diagnostics(wm.cat12.icv.bias.session$fit)

##
## Get values for table
##
per_diff(wm.cat12.bias.session)
per_diff(wm.cat12.icv.bias.session)
...
##
# 
# wm.cat12.bias.common <- add_criterion(wm.cat12.bias.common,"kfold")
# wm.cat12.bias.session <- add_criterion(wm.cat12.bias.session,"kfold")
# 
# wm.cat12.kfold <- loo_compare(wm.cat12.bias.common, wm.cat12.bias.session, criterion="kfold")
# 
# #Get ELPD for the common model: 
# print(wm.cat12.bias.common$kfold$estimates)

```

###CSF VOL(CAT12)
```{r CSF VOL CAT12 model, eval=FALSE, echo=FALSE}

#S2 as reference (1st scan at new location)
fs$session <- relevel(fs$session, ref="S2")

prior_name = paste0('student_t(3,0,',mean(fs$csf.vol.cat12)*prior_percent,')', sep="")

##
## Model 1 -- Bias + shared variance across move & within
## 
#0chains
csf.cat12.bias.common <- brm(csf.vol.cat12 ~  session + (common|id),
           control = list(adapt_delta = 0.99,max_treedepth=15),
           iter = 10000, family=student(), data=fs,
           algorithm = c("sampling"),
           prior = set_prior(prior_name,class="b"))
summary(csf.cat12.bias.common)
...
#4 chains
csf.cat12.bias.session <- brm(csf.vol.cat12 ~  session + (session|id),
           control = list(adapt_delta = 0.999,max_treedepth=15),
           iter = 15000, family=student(), data=fs,
           algorithm = c("sampling"), 
           prior = set_prior(prior_name,class="b"))
summary(csf.cat12.bias.session)
check_hmc_diagnostics(csf.cat12.bias.session$fit)
...
# 4 chain
csf.cat12.icv.bias.session <- brm(csf.vol.cat12/icv.vol.cat12 ~  session + (session|id),
           control = list(adapt_delta = 0.999,max_treedepth=15),
           iter = 15000, family=student(), data=fs,
           algorithm = c("sampling"), 
           prior = set_prior(prior_name,class="b"))
summary(csf.cat12.icv.bias.session)
check_hmc_diagnostics(csf.cat12.icv.bias.session$fit)

##
## Get values for table
##
per_diff(csf.cat12.bias.session)
per_diff(csf.cat12.icv.bias.session)
...
##
# 
# csf.cat12.bias.common <- add_criterion(csf.cat12.bias.common,"kfold")
# csf.cat12.bias.session <- add_criterion(csf.cat12.bias.session,"kfold")
# 
# csf.cat12.kfold <- loo_compare(csf.cat12.bias.common, csf.cat12.bias.session, criterion="kfold")
# 
# #Get ELPD for the common model: 
# print(csf.cat12.bias.common$kfold$estimates)

```

###CBF(CAT12)
```{r CBF CAT12 model, eval=FALSE, echo=FALSE}

#S2 as reference (1st scan at new location)
fs$session <- relevel(fs$session, ref="S2")

prior_name = paste0('student_t(3,0,',mean(fs$cbf.gm.cat12)*prior_percent,')', sep="")

##
## Model 1 -- Bias + shared variance across move & within
## 
#0 chains
cbf.gm.cat12.bias.common <- brm(cbf.gm.cat12 ~  session + (common|id),
           control = list(adapt_delta = 0.99,max_treedepth=15),
           iter = 10000, family=student(), data=fs,
           algorithm = c("sampling"),
           prior = set_prior(prior_name,class="b"))
summary(cbf.gm.cat12.bias.common)
check_hmc_diagnostics(cbf.gm.cat12.bias.session$fit)
...
# 0 chain
cbf.gm.cat12.bias.session <- brm(cbf.gm.cat12 ~  session + (session|id),
           control = list(adapt_delta = 0.99,max_treedepth=15),
           iter = 10000, family=student(), data=fs,
           algorithm = c("sampling"), 
           prior = set_prior(prior_name,class="b"))
summary(cbf.gm.cat12.bias.session)
check_hmc_diagnostics(cbf.gm.cat12.bias.session$fit)
...
## Get values for table
##
per_diff(cbf.gm.cat12.bias.session)
...
##
# 
# cbf.gm.cat12.bias.common <- add_criterion(cbf.gm.cat12.bias.common,"kfold")
# cbf.gm.cat12.bias.session <- add_criterion(cbf.gm.cat12.bias.session,"kfold")
# 
# cbf.gm.cat12.kfold <- loo_compare(cbf.gm.cat12.bias.common, cbf.gm.cat12.bias.session, criterion="kfold")
# 
# #Get ELPD for the common model: 
# print(cbf.gm.cat12.bias.common$kfold$estimates)
...
#Filter dataset for only S1 & S2. Following code needs this to be a dataframe.
gm.cat12.12 <- fs %>% 
  select(id,session,gm.vol.cat12,icv.vol.cat12) %>% 
  filter(session!="S3") %>% 
  as.data.frame()


#Fit mixed effects model with brms
gm.cat12.brm.12 <- brm(gm.vol.cat12/icv.vol.cat12 ~ session + (1|id),
      control = list(adapt_delta = 0.99,max_treedepth=15),
      iter = 10000, family=student(), algorithm=c("sampling"),
       prior = set_prior(prior_name,class="b"), data=gm.cat12.12)
summary(gm.cat12.brm.12)

#Calculate ICC & CIs
gm.cat12.brm.icc.12 <- sjstats::icc(gm.cat12.brm.12, prob=0.95)   
##*******************************************  
...
#Fit mixed effects model with brms
gm.cat12.brm.23 <- brm(gm.vol.cat12/icv.vol.cat12 ~ session + (1|id),
      control = list(adapt_delta = 0.99,max_treedepth=15),
      iter = 10000, family=student(), algorithm=c("sampling"),
       prior = set_prior(prior_name,class="b"), data=rd.23)
summary(gm.cat12.brm.23)

#Calculate ICC & CIs
gm.cat12.brm.icc.23 <- sjstats::icc(gm.cat12.brm.23, prob=0.95) 
##*******************************************
...
## wsCV
##
gm.vol.cat12.12 <- gm.cat12.12 %>% 
  spread(session,gm.vol.cat12)


gm.vol.cat12.23 <- gm.cat12.23 %>% 
  spread(session,gm.vol.cat12)

## call the wsCV function
gm.cat12.wsCV.s12 <- wsCV.s12(gm.vol.cat12.12) 
gm.cat12.wsCV.s23 <- wsCV.s23(gm.vol.cat12.23)
...
#Filter dataset for only S1 & S2. Following code needs this to be a dataframe.
wm.cat12.12 <- fs %>% 
  select(id,session,wm.vol.cat12,icv.vol.cat12) %>% 
  filter(session!="S3") %>% 
  as.data.frame()


#Fit mixed effects model with brms
wm.cat12.brm.12 <- brm(wm.vol.cat12/icv.vol.cat12 ~ session + (1|id),
      control = list(adapt_delta = 0.99,max_treedepth=15),
      iter = 10000, family=student(), algorithm=c("sampling"),
       prior = set_prior(prior_name,class="b"), data=wm.cat12.12)
summary(wm.cat12.brm.12)

#Calculate ICC & CIs
wm.cat12.brm.icc.12 <- sjstats::icc(wm.cat12.brm.12, prob=0.95)   
##*******************************************  
...
#Fit mixed effects model with brms
wm.cat12.brm.23 <- brm(wm.vol.cat12/icv.vol.cat12 ~ session + (1|id),
      control = list(adapt_delta = 0.99,max_treedepth=15),
      iter = 10000, family=student(), algorithm=c("sampling"),
       prior = set_prior(prior_name,class="b"), data=wm.cat12.23)
summary(wm.cat12.brm.23)

#Calculate ICC & CIs
wm.cat12.brm.icc.23 <- sjstats::icc(wm.cat12.brm.23, prob=0.95) 
##*******************************************
...
## wsCV
##
wm.vol.cat12.12 <- wm.cat12.12 %>% 
  spread(session,wm.vol.cat12)


wm.vol.cat12.23 <- wm.cat12.23 %>% 
  spread(session,wm.vol.cat12)

## call the wsCV function
wm.cat12.wsCV.s12 <- wsCV.s12(wm.vol.cat12.12) 
wm.cat12.wsCV.s23 <- wsCV.s23(wm.vol.cat12.23)
...
###CSF CAT12
```{r csf ICC, echo=FALSE}

#Metric  'csf.vol.cat12'
...
#Filter dataset for only S1 & S2. Following code needs this to be a dataframe.
csf.cat12.12 <- fs %>% 
  select(id,session,csf.vol.cat12,icv.vol.cat12) %>% 
  filter(session!="S3") %>% 
  as.data.frame()


#Fit mixed effects model with brms
csf.cat12.brm.12 <- brm(csf.vol.cat12/icv.vol.cat12 ~ session + (1|id),
      control = list(adapt_delta = 0.99,max_treedepth=15),
      iter = 10000, family=student(), algorithm=c("sampling"),
       prior = set_prior(prior_name,class="b"), data=csf.cat12.12)
summary(csf.cat12.brm.12)

#Calculate ICC & CIs
csf.cat12.brm.icc.12 <- sjstats::icc(csf.cat12.brm.12, prob=0.95)   
##*******************************************  
...
#Fit mixed effects model with brms
csf.cat12.brm.23 <- brm(csf.vol.cat12/icv.vol.cat12 ~ session + (1|id),
      control = list(adapt_delta = 0.99,max_treedepth=15),
      iter = 10000, family=student(), algorithm=c("sampling"),
       prior = set_prior(prior_name,class="b"), data=csf.cat12.23)
summary(csf.cat12.brm.23)

#Calculate ICC & CIs
csf.cat12.brm.icc.23 <- sjstats::icc(csf.cat12.brm.23, prob=0.95) 
##*******************************************
...
## wsCV
##
csf.vol.cat12.12 <- csf.cat12.12 %>% 
  spread(session,csf.vol.cat12)


csf.vol.cat12.23 <- csf.cat12.23 %>% 
  spread(session,csf.vol.cat12)

## call the wsCV function
csf.cat12.wsCV.s12 <- wsCV.s12(csf.vol.cat12.12) 
csf.cat12.wsCV.s23 <- wsCV.s23(csf.vol.cat12.23)
...
###ASL CAT12
```{r cbf.gm ICC, echo=FALSE}

#Metric  'cbf.gm.vol.cat12'
...
#Filter dataset for only S1 & S2. Following code needs this to be a dataframe.
cbf.gm.cat12.12 <- fs %>% 
  select(id,session,cbf.gm.cat12,icv.vol.cat12) %>% 
  filter(session!="S3") %>% 
  as.data.frame()


#Fit mixed effects model with brms
cbf.gm.cat12.brm.12 <- brm(cbf.gm.cat12 ~ session + (1|id),
      control = list(adapt_delta = 0.99,max_treedepth=15),
      iter = 10000, family=student(), algorithm=c("sampling"),
       prior = set_prior(prior_name,class="b"), data=cbf.gm.cat12.12)
summary(cbf.gm.cat12.brm.12)

#Calculate ICC & CIs
cbf.gm.cat12.brm.icc.12 <- sjstats::icc(cbf.gm.cat12.brm.12, prob=0.95)   
##*******************************************  
...
#Fit mixed effects model with brms
cbf.gm.cat12.brm.23 <- brm(cbf.gm.cat12 ~ session + (1|id),
      control = list(adapt_delta = 0.99,max_treedepth=15),
      iter = 10000, family=student(), algorithm=c("sampling"),
       prior = set_prior(prior_name,class="b"), data=cbf.gm.cat12.23)
summary(cbf.gm.cat12.brm.23)

#Calculate ICC & CIs
cbf.gm.cat12.brm.icc.23 <- sjstats::icc(cbf.gm.cat12.brm.23, prob=0.95) 
##*******************************************
...
## wsCV
##
cbf.gm.vol.cat12.12 <- cbf.gm.cat12.12 %>% 
  spread(session,cbf.gm.cat12)


cbf.gm.vol.cat12.23 <- cbf.gm.cat12.23 %>% 
  spread(session,cbf.gm.cat12)

## call the wsCV function
cbf.gm.cat12.wsCV.s12 <- wsCV.s12(cbf.gm.vol.cat12.12) 
cbf.gm.cat12.wsCV.s23 <- wsCV.s23(cbf.gm.vol.cat12.23)
...
#CAT12 (these are all normalized by ICV)
gm.cat12.brm.icc.12 <- readRDS("gm.cat12.brm.icc.12.Rds")
gm.cat12.brm.icc.23 <- readRDS("gm.cat12.brm.icc.23.Rds")

wm.cat12.brm.icc.12 <- readRDS("wm.cat12.brm.icc.12.Rds")
wm.cat12.brm.icc.23 <- readRDS("wm.cat12.brm.icc.23.Rds")

csf.cat12.brm.icc.12 <- readRDS("csf.cat12.brm.icc.12.Rds")
csf.cat12.brm.icc.23 <- readRDS("csf.cat12.brm.icc.23.Rds")

cbf.gm.cat12.brm.icc.12 <- readRDS("cbf.gm.cat12.brm.icc.12.Rds")
cbf.gm.cat12.brm.icc.23 <- readRDS("cbf.gm.cat12.brm.icc.23.Rds")
...
gm.cat12.brm.23 <- brm(gm.vol.cat12/icv.vol.cat12 ~ session + (1|id),
      control = list(adapt_delta = 0.99,max_treedepth=15),
      iter = 10000, family=student(), algorithm=c("sampling"),
       prior = set_prior(prior_name,class="b"), data=gm.cat12.23)
summary(gm.cat12.brm.23)
...
#n = (Zα/2+Zβ)2 *2*σ2 / diff2,
# 
# where Zα/2 is the critical value of the Normal distribution at α/2 (e.g. for a confidence level of 95%, α is 0.05 and the critical value is 1.96), Zβ is the critical value of the Normal distribution at β (e.g. for a power of 80%, β is 0.2 and the critical value is 0.84), σ2 is the population variance, and diff is the difference you would like to detect.
...
#Calculate sample sizes needed, given the observed variance.
n.gm.cat12 <- sample_size(gm.cat12.bias.session, mag_diff, alpha, power)
n.gm.cat12.icv <- sample_size(gm.cat12.icv.bias.session, mag_diff, alpha, power)


n.wm.cat12 <- sample_size(wm.cat12.bias.session, mag_diff, alpha, power)
n.wm.cat12.icv <- sample_size(wm.cat12.icv.bias.session, mag_diff, alpha, power)

n.csf.cat12 <- sample_size(csf.cat12.bias.session, mag_diff, alpha, power)
n.csf.cat12.icv <- sample_size(csf.cat12.icv.bias.session, mag_diff, alpha, power)

n.cbf.cat12 <- sample_size(cbf.gm.cat12.bias.session, mag_diff, alpha, power)
...
levels(ss.g$metric) <- c("CBF",  "WM Vol", "Cortical Vol", "SA", "GM Vol", "SubCort Vol",
                         "SubCort Vol/ICV", "WM Vol/ICV", "Cortical Vol/ICV", "FA", "GM Vol/ICV", 
                         "SA/ICV", "CTh", "MD", "RD", "AD")
...
pal <- wes_palette(name="FantasticFox1", colorCount, type="continuous")
...
ss.plot <- ggplot(ss.g,aes(x=metric, y=size, fill=metric)) +
  ...
  coord_flip()
ss.plot
ggsave("Sample_size_4per_fox.pdf",width=8,height=5)
...
ss.plot.b <- ggplot(ss.g,aes(x=metric, y=size)) +
  geom_bar(stat = "identity") + 
  #scale_fill_brewer(getPalette(colorCount)) +
  ylab("Sample size per group") +
  scale_x_discrete()+
...
ss.plot.b
ggsave("Sample_size_4per_black.pdf",width=8,height=5)


```


##Figure: Sample size(CAT12)
```{r}


ss.cat12 <- read.csv("analysis_spreadsheets/sample_size_table_cat12.csv")

ss.cat12.g<- ss.cat12 %>% 
  gather(metric,size,c(`GM` , `GM.ICV` , `WM` , `WM.ICV` ,
                       `CSF` , `CSF.ICV`, `CBF`)) %>% 
  mutate(Mean.difference = factor(Mean.difference)) %>% 
  filter(Mean.difference=="4") 

ss.cat12.g$metric <- reorder(ss.cat12.g$metric,-ss.cat12.g$size)
...
colorCount = length(unique(ss.cat12.g$metric))
getPalette = colorRampPalette(brewer.pal(8,"Dark2"))


ss.cat12.plot <- ggplot(ss.cat12.g,aes(x=metric, y=size, fill=metric)) +
  geom_bar(stat = "identity", fill= getPalette(colorCount)) + 
  #scale_fill_brewer(getPalette(colorCount)) +
  ylab("Sample size per group") +
  scale_x_discrete()+
...
ss.cat12.plot
ggsave("Sample_size_CAT12_4per.pdf",width=8,height=5)
